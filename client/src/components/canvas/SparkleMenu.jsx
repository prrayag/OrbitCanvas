...
const AI_ACTIONS = [
  { id: 'brainstorm', label: 'Brainstorm Features', cmd: '001' },
  { id: 'deconstruct', label: 'Deconstruct Tech Stack', cmd: '002' },
  { id: 'ideas', label: 'Generate Ideas', cmd: '003' },
  { id: 'deepdive', label: 'Deep Dive', cmd: '004' },
];
...
function SparkleMenu({ onSelect, onClose }) {
  ...
  return (
    <>
      ...
      {/* Menu */}
      <div
        className="absolute top-1/2 left-full ml-3 -translate-y-1/2 z-50 menu-enter"
        onMouseDown={(e) => e.stopPropagation()}
      >
